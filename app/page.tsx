  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-between px-6 py-12 relative overflow-hidden bg-gradient-to-b from-[#FDFEFE] to-[#F2F5FA] min-h-screen">
      ...
      <div className="z-10 flex flex-col items-center my-6 relative w-full max-w-[300px] md:max-w-[400px]">
        ...
        <div className="speech-bubble bg-white text-brand-slate font-bold text-xs md:text-sm p-4 rounded-2xl shadow-md border-2 border-slate-100 max-w-[220px] md:max-w-[280px] text-center mb-6 relative animate-float">
          <span>"Hey there, explorer! I'm Quiro. Let's bend physics together!"</span>
        </div>

        {/* Glow behind Mascot */}
        <div className="absolute top-24 w-36 h-36 md:w-48 md:h-48 bg-gradient-to-tr from-brand-teal to-brand-purple opacity-20 rounded-full blur-2xl animate-pulse" />
      ...
      <div className="z-10 w-full flex flex-col items-center gap-4 max-w-[280px] md:max-w-[360px]">
        <Link href="/map" className="w-full">
          <Button variant="accent" size="lg" className="w-full h-16 md:h-20 text-lg md:text-xl tracking-wide flex items-center justify-center gap-2 shadow-xl hover:shadow-2xl transition-all">
